...
... artifacts are [released to Clojars](https://clojars.org/totto). If you are using Maven, add the following repository
...
totto is built from the ground up for Clojure 1.5.1 and up.


## Continuous Integration Status

[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/totto.png)](http://travis-ci.org/clojurewerkz/totto)



## ... Is a ClojureWerkz Project

totto is part of the [group of Clojure libraries known as ClojureWerkz](http://clojurewerkz.org), together with
